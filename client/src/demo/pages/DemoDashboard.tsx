...
export function DemoDashboard() {
  const { niches, topNiches, latestAnalyses } = useDemoContext();
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Explore all features with sample data. Sign up to save your own analyses.
              </p>
            </div>
          </div>
          <Link to="/">
